...
export function ModernLandingPage({ onNavigate }: ModernLandingPageProps) {
  ...
  >([]);
  const [constellationCircles, setConstellationCircles] = useState<
    Array<{
      id: number;
      cx: number;
      cy: number;
      ...
      >
          ...
          {isDark && (
            <>
              ...
              <svg className="absolute inset-0 w-full h-full opacity-10">
                {constellationCircles.map((circle) => (
                  <motion.circle
                    key={circle.id}
                    cx={`${circle.cx}%`}
                    cy={`${circle.cy}%`}
        ...
        <motion.header
          className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
            isScrolled
              ? isDark
                ? "bg-[#0A0E27]/95 backdrop-blur-xl shadow-lg shadow-white/20 py-3"
              ...
              <nav className="hidden lg:flex items-center gap-8">
                ...
                >
                  ...
                  >
                    Immigration
                    <ChevronDown
                      className={`w-4 h-4 transition-transform ${showMegaMenu === "immigration" ? "rotate-180" : ""}`}
                    />
                  </button>
                    ...
                    {showMegaMenu === "immigration" && (
                      ...
                      >
                        <div className="grid grid-cols-2 gap-6">
                          <div>
                            <h3
                              className={`text-sm font-bold mb-4 ${isDark ? "text-slate-400" : "text-slate-500"}`}
                            >
                ...
                >
                  ...
                  >
                    Education
                    <ChevronDown
                      className={`w-4 h-4 transition-transform ${showMegaMenu === "education" ? "rotate-180" : ""}`}
                    />
                  </button>
        ...
        <main className="relative z-10 pt-32">
          ...
          <section className="container mx-auto px-6 py-20">
            ...
            >
              ...
              >
                Navigate your path to international opportunities with expert
                guidance
                <br />
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto mt-16">
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 to-purple-500/0 group-hover:from-blue-500/20 group-hover:to-purple-500/20 transition-all duration-500" />
                </div>
                ...
                <div className="p-8">
                  ...
                  >
                    Discover personalized immigration pathways based on your
                    profile. Get matched with the best visa options for your
                    goals.
                  </p>
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-emerald-500/0 to-teal-500/0 group-hover:from-emerald-500/20 group-hover:to-teal-500/20 transition-all duration-500" />
                </div>
                ...
                <div className="p-8">
                  ...
                  <p
                    className={`mb-6 ${isDark ? "text-slate-400" : "text-slate-600"}`}
                  >
                    Explore universities and degree programs in Sri Lanka.
                    Compare courses, fees, and accreditation to make the best
                    choice.
                  </p>
          ...
          <section id="features" className="container mx-auto px-6 py-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-2xl bg-gradient-to-br from-${feature.color}-500 to-${feature.color}-600 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                  >
        ...
        {/* Footer */}
        <footer
          className={`relative mt-20 ${isDark ? "bg-slate-500" : "bg-red-600"} text-white overflow-hidden`}
        >
          ...
          <div className="relative container mx-auto px-6 py-16">
            <div className="grid md:grid-cols-4 gap-12 mb-12">
              ...
              <div className="md:col-span-1">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg bg-gradient-to-r from-[#E427F5] to-[#00FA22] bg-clip-text text-transparent">
                      Global Immigateway
                    </h3>
                    <p className="text-xs bg-gradient-to-r from-[#E427F5] to-[#00FA22] bg-clip-text text-transparent">
                      Your Path to Success
                    </p>
                  </div>
                </div>
                <p className="text-sm mb-6 bg-gradient-to-r from-[#E427F5] to-[#00FA22] bg-clip-text text-transparent">
                  Empowering dreams through expert immigration and education
                ...
                <div className="flex gap-3">
                  {[Facebook, Instagram, Linkedin].map((Icon, i) => (
                    <motion.a
                      key={i}
                      href="#"
                      className="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-gradient-to-r hover:from-[#E427F5] hover:to-[#00FA22] transition-all"
              ...
              {/* Quick Links */}
              <div>
                <h4 className="font-bold mb-4 bg-gradient-to-r from-[#E427F5] to-[#00FA22] bg-clip-text text-transparent">
                  Quick Links
                </h4>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i}>
                      <motion.a
                        href="#"
                        className="bg-gradient-to-r from-[#E427F5] to-[#00FA22] bg-clip-text text-transparent hover:opacity-80 transition-opacity flex items-center gap-2 group"
                        whileHover={{ x: 5 }}
                      >
                        <ChevronRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity text-[#00FA22]" />
                        {link}
                      </motion.a>
                    </li>
                  ))}
              ...
              <div>
                ...
                <div className="space-y-4">
                  <a
                    href="mailto:info@globalimmigateway.com"
                    className="flex items-center gap-3 group"
                  >
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-[#E427F5] to-[#00FA22] flex items-center justify-center transition-all">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold bg-gradient-to-r from-[#E427F5] to-[#00FA22] bg-clip-text text-transparent">
                        info@globalimmigateway.com
                      </p>
                    </div>
                  </a>
                  <a
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-[#E427F5] to-[#00FA22] flex items-center justify-center">
            ...
            <div className="border-t border-slate-800 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-sm bg-gradient-to-r from-[#E427F5] to-[#00FA22] bg-clip-text text-transparent">
                  © 2024 Global Immigateway. All rights reserved.
                </p>
                <div className="flex gap-6 text-sm">
                  <a
                    href="#"
                    className="bg-gradient-to-r from-[#E427F5] to-[#00FA22] bg-clip-text text-transparent hover:opacity-80 transition-opacity"
                  >
                    Privacy Policy
                  </a>
                  <a
              ...
              >
                ...
                <div className="mt-6 flex gap-3 justify-center">
                  {[Facebook, Instagram, Linkedin].map((Icon, i) => (
                    ...
                    >
                      <Icon
                        className={`w-5 h-5 ${isDark ? "text-slate-300" : "text-slate-600"} group-hover:text-white`}
                      />
                    </motion.a>
                  ))}
                </div>
              ...
              >
                ...
                <div className="relative mb-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span
                      className={`px-4 ${isDark ? "bg-slate-800 text-slate-400" : "bg-white text-slate-500"}`}
                    >
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      setShowAuthModal(
                        showAuthModal === "login" ? "signup" : "login",
                      )
                    }
