          ...
          >
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <a href="mailto:info@globalimmigateway.com" className={`flex items-center gap-4 p-4 rounded-xl ${
                ...
                <a href="tel:+94112345678" className={`flex items-center gap-4 p-4 rounded-xl ${
                  isDark ? 'bg-slate-700/50 hover:bg-slate-700' : 'bg-slate-50 hover:bg-slate-100'
                } transition-colors group`}>
                ...
                {[Facebook, Instagram, Linkedin].map((Icon, i) => (
                  <motion.a
                    ...
                    className={`w-12 h-12 rounded-lg ${
                      isDark ? 'bg-slate-700 hover:bg-blue-600' : 'bg-slate-100 hover:bg-blue-600'
